...
class TimeBasedSalaryAdjustmentService
{
    protected $repository;
    protected $companyUserRepository;

    public function __construct(TimeBasedSalaryAdjustmentRepository $repository, CompanyUserRepository $companyUserRepository)
    {
