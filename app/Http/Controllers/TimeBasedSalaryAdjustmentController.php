...
use App\Services\TimeBasedSalaryAdjustmentService;

class TimeBasedSalaryAdjustmentController extends Controller
{
    protected $service;

    public function __construct(TimeBasedSalaryAdjustmentService $service)
    {
