...
class SalaryController extends Controller
{
    ...
    public function store(Request $request, $employeeID)
    {
        $validator = \Validator::make($request->all(), [
            ...
            'daily_salary_calculation_base' => 'sometimes|nullable|string|in:WORK_DAYS,CALENDAR_DAYS',
    ...
    public function update(Request $request, $employeeID, $salaryID)
    {
        ...
        $validator = \Validator::make($request->all(), [
            ...
            'includes_employee_pension' => 'sometimes|boolean',
            'includes_company_pension' => 'sometimes|boolean',
            'daily_salary_calculation_base' => 'sometimes|string|in:WORK_DAYS,CALENDAR_DAYS',
